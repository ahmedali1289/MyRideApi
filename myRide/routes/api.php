...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::post('accept-ride', [RideController::class, 'acceptRideDriver']);
    Route::post('cancel-ride', [RideController::class, 'cancelRideByPassenger']);
    Route::get('get-accept-ride', [RideController::class, 'driverAcceptedRides']);
